...
public class resetPasswordTest {
    ...
    WebDriver driver; 
    WebDriverWait wait; 
    String url = " https://teamname.sitict.net/testen/resetPassword.php";
...
@After
    ...
    public void test_positive_resetPassword() 
		...
		//click submit
		driver.findElement(By.name("reset_password")).submit();
    ...
    public void test_negative_resetPassword() 
		...
		//enter input
                driver.findElement(By.name("password_1")).sendKeys(password_1);
                driver.findElement(By.name("password_2")).sendKeys(password_3);
		//click submit
		driver.findElement(By.name("reset_password")).submit();
