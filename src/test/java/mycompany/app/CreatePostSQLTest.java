 ...
 * @author pheeb
 */
public class CreatePostSQLTest {
...
@After
    ...
    public void test_create_post_sql1() 
		...
		driver.findElement(By.id("PostContent")).sendKeys(sql1);
		//click submit
    ...
    public void test_create_post_sql128() 
		...
		//use each and every possible SQL statement and inject on PostComment field and submitthrows InterruptedException { 
    	//get web page
    	driver.get(url);
    	//wait until page is loaded or timeout error
    	wait.until(ExpectedConditions.titleContains("Busbly Login")); 
