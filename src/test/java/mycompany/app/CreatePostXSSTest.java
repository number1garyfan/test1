 ...
 * @author pheeb
 */
public class CreatePostXSSTest {
    
	WebDriver driver = new HtmlUnitDriver(true); 
    WebDriverWait wait; 
    String url = "https://teamname.sitict.net/testen/createPost.php";
...
@After
    ...
    //                 stay on same page
    public void test_create_post_xss1() 
    		throws InterruptedException { 
    	//get web page
    	driver.get(url);
    	//wait until page is loaded or timeout error
    	wait.until(ExpectedConditions.titleContains("Busbly Login")); 
    	driver.findElement(By.name("email")).sendKeys("a@email.com");
    ...
    public void test_create_xss21() 
		...
		//use each and every possible SQL statement and inject on PostComment field and submit	throws InterruptedException { 
    	//get web page
    	driver.get(url);
    	//wait until page is loaded or timeout error
    	wait.until(ExpectedConditions.titleContains("Busbly Login")); 
