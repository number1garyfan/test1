...
//        System.out.println(driver.getTitle());
    ...
    @Test
    //Expected result: check if alert exist 
    public void test_delete_thread_pass() 
		throws InterruptedException { 
        ...
        driver.findElement(By.name("TopicName")).sendKeys("delete thread");
        driver.findElement(By.name("submitCreateTopic")).click();
        //go back home
        
        driver.findElement(By.xpath("//*[@id=\"navbarsExampleDefault\"]/ul[1]/li[1]/a")).click();
        System.out.println(driver.getCurrentUrl());
        //go into topic call delete thread
        driver.findElement(By.xpath("//button[text()='delete thread']")).submit();
...
//        System.out.println(driver.getTitle());
    ...
    @Test
    //Expected result: check if alert exist 
    public void test_delete_topic_pass() 
		throws InterruptedException { 
        ...
        driver.findElement(By.name("TopicName")).sendKeys("ZAO AN FRONT");
        driver.findElement(By.name("submitCreateTopic")).click();
        //go back home
        
        driver.findElement(By.xpath("//*[@id=\"navbarsExampleDefault\"]/ul[1]/li[1]/a")).click();
        System.out.println(driver.getCurrentUrl());
        driver.findElement(By.xpath("//*[@id=\"dtBasicExample\"]/tbody/tr[7]/td[4]/div/form[2]/button")).click();
...
//        System.out.println(driver.getTitle());
    ...
    public void test_update_profile_pass() 
        ...
        //check result 
        String expectedResult = "https://teamname.sitict.net/testen/viewProfile.php"; 
